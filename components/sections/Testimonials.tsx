...
const testimonials = [
  { name: "Sarah M.",   role: "CEO",                  country: "🇬🇧 UK",         initial: "SM", quote: "Zbrainstorm delivered our fintech dashboard in 6 weeks — on budget, pixel-perfect, and with features we didn't even know we needed. Best agency decision we've made.", rating: 5 },
  { name: "Kwame A.",   role: "Product Manager",      country: "🇬🇭 Ghana",      initial: "KA", quote: "Went cross-platform on Zbrainstorm's recommendation. Quality on par with top-tier US agencies at a fraction of the cost. The app has been rock-solid since launch.", rating: 5 },
  ...
  { name: "James O.",   role: "Founder",              country: "🇨🇦 Canada",     initial: "JO", quote: "I've worked with three other agencies before Zbrainstorm. None of them communicated as clearly or delivered as consistently. They felt like a true extension of our team.", rating: 5 },
  ...
  { name: "Daniel R.",  role: "CTO",                  country: "🇺🇸 USA",        initial: "DR", quote: "We handed Zbrainstorm a rough spec and they handed back a polished product. They flagged things we hadn't thought of, suggested smarter approaches, and hit every milestone.", rating: 5 },
