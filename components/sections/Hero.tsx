    ...
    <div className="relative w-full max-w-[480px]" style={{ height: 340 }}>
      ...
      >
        ...
        <div className="flex items-center gap-2 px-4 py-3 border-b border-[#1E1E2E]" style={{ background: "#141420" }}>
          ...
          <span className="ml-3 text-[11px] font-mono" style={{ color: "#4B4B6A" }}>zbrainstorm/app.ts</span>
...
function PriceChartIllustration() {
  ...
  const cols = [
    ...
    { label: "Zbrainstorm", value: "$6k", height: 72, color: "#F5A623" },
  ];
...
const slides = [
  ...
  },
  {
    ...
    ctas: [
      ...
      { label: "Why Zbrainstorm", href: "#about",   primary: false },
    ],
              ...
              >
                {s.right === "code"  && (
                  ...
                  >
                    <img
                      src="/images/v6.png"
                      alt="Zbrainstorm — Digital Product Development"
                    ...
                    <div className="lg:hidden w-full max-w-[340px] mx-auto rounded-2xl p-3"
                      ...
                      <div className="flex items-center justify-between mb-3 px-1">
                        <div className="flex items-center gap-1.5">
                          ...
                          <span className="text-[9px] font-black uppercase tracking-widest" style={{ color:"#9CA3AF" }}>Zbrainstorm · Stats</span>
                        </div>
